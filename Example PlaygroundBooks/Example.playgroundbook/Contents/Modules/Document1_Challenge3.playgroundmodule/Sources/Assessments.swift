...
public func assessmentPoint() -> AssessmentResults {
    ...
    var success = NSLocalizedString("### Amazing job! \nYou just completed **Commands**. Now it’s time to learn about functions. \n\n[Introduction to Functions](@next)", comment:"Success message")
    
    
    var hints = [
        NSLocalizedString("Look at the puzzle world and find the route that requires the fewest commands.", comment:"Hint"),
    ...
    if checker.numberOfStatements < 9 {
        ...
        success = NSLocalizedString("### Good work! \nYou’ve used your new skills to solve the puzzle. You can move on to learn about functions, but as an added challenge, can you find an even shorter solution? \n\n[**Introduction to Functions**](@next)", comment:"Success message")
