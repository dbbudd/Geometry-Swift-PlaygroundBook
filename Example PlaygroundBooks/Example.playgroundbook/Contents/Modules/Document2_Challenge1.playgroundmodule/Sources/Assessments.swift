...
public func assessmentPoint() -> AssessmentResults {
    ...
    if checker.didUseForLoop || checker.didUseWhileLoop {
        ...
        hints[0] = NSLocalizedString("Oops, you called `collectGem()` when no gem was present! This is actually a bug in your code—you should only collect a gem if one is present on that tile.", comment:"Hint")
        ...
        hints[0] = NSLocalizedString("To get the most out of your function, be sure to call it in all four locations that have a gem and a switch.", comment:"Hint")
    }
