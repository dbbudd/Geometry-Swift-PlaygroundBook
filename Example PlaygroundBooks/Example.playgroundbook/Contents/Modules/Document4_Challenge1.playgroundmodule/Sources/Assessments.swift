...
public func assessmentPoint() -> AssessmentResults {
    ...
    if !checker.didUseConditionalStatement("if") {
        success = NSLocalizedString("### You can improve your code. \nUsing conditional code with an `if` statement will help you solve this problem more efficiently. Add an `if` statement and give it another shot.", comment:"Success message")
