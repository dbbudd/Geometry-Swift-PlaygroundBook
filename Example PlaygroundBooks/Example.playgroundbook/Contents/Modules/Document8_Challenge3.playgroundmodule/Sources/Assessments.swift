...
var hints = [
    NSLocalizedString("On the first platform, a random number of gems will appear. Check each tile and increment a gem-counting variable to count the number of gems collected.", comment:"Hint"),
