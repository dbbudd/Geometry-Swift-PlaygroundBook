...
public func assessmentPoint() -> AssessmentResults {
    ...
    if usesNotOperator && checker.didUseConditionalStatement {
        ...
        success = NSLocalizedString("You figured out how to solve the puzzle without using the `!` operator. Great work, finding a creative solution for a problem is the sign of a great coder! However, you should also figure out how to solve the puzzle using the `!` operator so that you’ll know how to use it in future coding situations.", comment:"Success message")
