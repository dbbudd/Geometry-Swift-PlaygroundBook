...
public func assessmentPoint() -> AssessmentResults {
    ...
    var hints = [
        NSLocalizedString("Add an `if` statement inside the `for` loop, then add your first condition. In the shortcut bar, select the `||` operator and add your second condition. Also create an `else` block to move forward if both conditions are false.", comment:"Hint"),
