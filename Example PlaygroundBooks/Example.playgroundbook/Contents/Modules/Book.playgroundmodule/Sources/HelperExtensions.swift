...
public struct Signpost {
    ...
    public static let liveViewControllerViewDidAppear = Signpost("LiveViewControllerViewDidAppear")
    ...
    public static let sceneDidLoad = Signpost("SceneDidLoad")
    public static let scenePerformFlyover = Signpost("ScenePerformFlyover")
    public static let sceneReadyToStart = Signpost("SceneReadyToStart")
    public static let sceneStartPlayback = Signpost("SceneStartPlayback")
