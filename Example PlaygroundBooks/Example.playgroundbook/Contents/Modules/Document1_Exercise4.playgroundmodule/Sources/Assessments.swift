...
public func assessmentPoint() -> AssessmentResults {
    ...
    if checker.numberOfStatements > 7 {
        hints[0] = NSLocalizedString("You’ve added more commands than you need. To rearrange existing code, press on a command to select it, then keep pressing as you drag it to a new location.", comment:"Hint")
        ...
        hints[0] = NSLocalizedString("Did you notice when the bug occurred? To rearrange your code, press on a command to select it, then keep pressing as you drag it to a new location.", comment:"Hint")
