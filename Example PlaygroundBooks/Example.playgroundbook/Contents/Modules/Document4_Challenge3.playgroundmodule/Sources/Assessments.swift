...
public func assessmentPoint() -> AssessmentResults {
    ...
    var hints = [
        NSLocalizedString("Along the central path, whenever you reach a gem, a stairway leads down to the right. Whenever you reach a closed switch, there’s another gem to the left.", comment:"Hint"),
