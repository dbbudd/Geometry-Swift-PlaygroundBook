...
public func assessmentPoint() -> AssessmentResults {
    ...
    if checker.didUseForLoop == false && checker.numberOfStatements > 12 {
        ...
        success = NSLocalizedString("### Great work! \nYour solution used both `for` loops and [conditional code](glossary://conditional%20code), incredible tools that make your code more intelligent and let you avoid repeating the same set of commands many times. However, you can improve your solution by writing your own custom function to check an individual tile for a gem or a closed switch. As an added challenge, try solving the puzzle by writing a custom function. Feel free to move on whenever you’re ready.  \n\n[**Next Page**](@next)", comment:"Success message")
    }
