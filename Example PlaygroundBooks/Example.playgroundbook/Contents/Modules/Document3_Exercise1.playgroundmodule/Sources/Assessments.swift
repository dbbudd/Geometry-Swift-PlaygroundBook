...
public func assessmentPoint() -> AssessmentResults {
    ...
    var success = NSLocalizedString("### Nice work! Loops simplify the repetition of a set of commands. In this exercise, a loop was provided for you, but in the next exercise, you’ll learn how to add a `for` loop to your code any time you want. \n\n[**Next Page**](@next)", comment:"Success message")
    ...
    if checker.didUseWhileLoop {
        ...
        hints[0] = NSLocalizedString("First select `number` and specify the number of times you want your loop to run. Then add the commands you want to repeat inside the `for` loop.", comment:"Hint")
    }
