...
let hints = [
    NSLocalizedString("First, [initialize](glossary://initialization) an [instance](glossary://instance) of your expert and an instance of your character.", comment:"Hint"),
