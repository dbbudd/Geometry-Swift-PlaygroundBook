...
* callout(Using the place method): `place` has three [parameters](glossary://parameter):
  ...
  - **row:** Takes an [Int](glossary://Int) for the row you want your character to be placed at.

    
    world.place(expert, atColumn: 1, row: 1)
 
 1. steps: Touch a tile in the puzzle world to reveal its coordinates.
